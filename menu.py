...
class Menu:
    ...
    def print_all_chirps(self):
        ...
        for p in public_chirps:
            ...
            users = p['user_count']
            all_chirps = p['all_chirps']
            print(line_string.format(name, orders, users, all_chirps))
        print('\033[34m*\033[37m' * total_width)
        print(line_string.format(
            '\033[36mTotals:\033[37m', view_all_chirps['public_chirps'], view_all_chirps['user_sum'], view_all_chirps['all_chirps_sum']))
